...
export const buttonVariants = cva(
  'inline-flex items-center justify-center gap-1.5 rounded-ink text-base font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink-primary-muted disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
