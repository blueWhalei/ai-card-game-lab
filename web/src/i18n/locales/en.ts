...
const en: typeof zhCN = {
  ...
  decision: {
    ...
    reason: {
      ...
      llm_fallback_action: 'Model parse failed; used the default action',
      thinking_pass_action_play: 'Thinking said pass, but a play was made',
      thinking_play_action_pass: 'Thinking said play, but the action was pass',
    },
    total: '{n} total',
